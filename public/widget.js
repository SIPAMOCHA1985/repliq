(function () {
  ...
  var css = [
    ...
    '#repliq-btn .repliq-badge{position:absolute;top:-4px;right:-4px;background:#EF4444;color:#fff;font-size:10px;font-weight:700;border-radius:50%;width:18px;height:18px;display:flex;align-items:center;justify-content:center;display:none;}',
    ...
    '#repliq-info{flex:1;min-width:0;}',
    ...
    '#repliq-messages::-webkit-scrollbar{width:4px;}',
    '#repliq-messages::-webkit-scrollbar-thumb{background:#ddd;border-radius:2px;}',
  ...
  btn.innerHTML = '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg><span class="repliq-badge">1</span>';
  ...
  panel.innerHTML = [
    ...
    '  <div id="repliq-info">',
    '    <div id="repliq-botname">' + escHtml(BOT_NAME) + '</div>',
  ...
  // Add typing indicator inside messages
  ...
  function renderHistory() {
    // Remove all existing messages (keep typing indicator)
  ...
  function openPanel() {
    ...
    btn.querySelector('.repliq-badge').style.display = 'none';
